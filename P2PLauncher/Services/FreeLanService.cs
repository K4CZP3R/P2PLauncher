    ...
    public class FreeLanService
    {
        ...
        public bool StartFreeLan()
        {
            ...
            switch (mode)
            {
                ...
                case FreeLanMode.CLIENT_HUB:
                    process.StartInfo.Arguments =
                        $"--security.passphrase {passphrase} --fscp.contact {hostIp}:12000 --tap_adapter.dhcp_proxy_enabled no --tap_adapter.ipv4_dhcp true --tap_adapter.metric 1 --switch.relay_mode_enabled yes --debug";
                    break;
            };
